...
/**
 * A TMXLayer which extends {@link SpriteBatchLowMemoryVBO} which in itself uses a 
 ...
 */
public class TMXLayerLowMemorySpriteBatch extends SpriteBatchLowMemoryVBO implements TMXConstants, TMXLayer {
	...
	public TMXLayerLowMemorySpriteBatch(final TMXTiledMap pTMXTiledMap, final Attributes pAttributes, final VertexBufferObjectManager pVertexBufferObjectManager, boolean pAllocateTiles) {
	...
	public TMXLayerLowMemorySpriteBatch(final TMXTiledMap pTMXTiledMap, final VertexBufferObjectManager pVertexBufferObjectManager, final TMXObjectGroup pTMXObjectGroup, boolean pAllocateTiles) {
