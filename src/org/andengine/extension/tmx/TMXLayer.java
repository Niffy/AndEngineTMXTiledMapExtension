...
public class TMXLayer extends SpriteBatch implements TMXConstants {
	...
	public TMXLayer(final TMXTiledMap pTMXTiledMap, final TMXLayer pTMXLayer,
		...
		this.mWidth = pTMXLayer.getWidth();
		this.mHeight = pTMXLayer.getHeight();
	 ...
	 *            using {@link #convertLocalToSceneCoordinates(float[])}
	 ...
	 * {@link #addTileByGlobalTileIDOrthogonal(int, int, ITMXTilePropertiesListener)}
	...
	private void drawOrthogonal(final GLState pGLState, final Camera pCamera) {
		...
		RectangularShapeCollisionChecker.fillVertices(0, 0, this.mWidth, this.mHeight,
				this.getLocalToSceneTransformation(), cullingVertices);
