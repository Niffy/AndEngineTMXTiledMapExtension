...
public class TMXLayer extends SpriteBatch implements TMXConstants {
	...
	// ===========================================================
	/**
	 * This reads in the attributes and creates a standard {@link SpriteBatch} which uses a {@link HighPerformanceSpriteBatchVertexBufferObject}
	 * @param pTMXTiledMap
	 * @param pAttributes
	 * @param pVertexBufferObjectManager
	 * @param pAllocateTiles
	 */
	public TMXLayer(final TMXTiledMap pTMXTiledMap, final Attributes pAttributes, final VertexBufferObjectManager pVertexBufferObjectManager, boolean pAllocateTiles) {
	...
	/**
	 * Create a new TMXLayer with a custom {@link ISpriteBatchVertexBufferObject}
	 * @param pTMXTiledMap
	 * @param pAttributes
	 * @param pCapacity
	 ...
	 * @param pAllocateTiles
	 */
	public TMXLayer(final TMXTiledMap pTMXTiledMap,final Attributes pAttributes, final int pCapacity, final ISpriteBatchVertexBufferObject pSpriteBatchVertexBufferObject, final VertexBufferObjectManager pVertexBufferObjectManager, boolean pAllocateTiles) {
		//super(null, SAXUtils.getIntAttributeOrThrow(pAttributes, TMXConstants.TAG_LAYER_ATTRIBUTE_WIDTH) * SAXUtils.getIntAttributeOrThrow(pAttributes, TMXConstants.TAG_LAYER_ATTRIBUTE_HEIGHT), pVertexBufferObjectManager);
		super(0,0,null,pCapacity,pSpriteBatchVertexBufferObject,PositionColorTextureCoordinatesShaderProgram.getInstance());
	...
	/**
	 * TMXLayer which uses a {@link HighPerformanceSpriteBatchVertexBufferObject}
	 * @param pTMXTiledMap
	 * @param pVertexBufferObjectManager
	 * @param pTMXObjectGroup
	 * @param pAllocateTiles
	 */
	public TMXLayer(final TMXTiledMap pTMXTiledMap,  final VertexBufferObjectManager pVertexBufferObjectManager, final TMXObjectGroup pTMXObjectGroup, boolean pAllocateTiles) {
	...
	/**
	 * Are {@link TMXTile} being allocated when creating {@link ITMXLayer}
	 * 
	 ...
	 */
	private void addTileByGlobalTileIDOrthogonal(final int pGlobalTileID, final ITMXTilePropertiesListener pTMXTilePropertyListener) {
		final TMXTiledMap tmxTiledMap = this.mTMXTiledMap;
	 ...
	 * @param pTMXTilePropertyListener {@link ITMXTilePropertiesListener} 
	 */
	private void addTileByGlobalTileIDIsometric(final int pGlobalTileID, final ITMXTilePropertiesListener pTMXTilePropertyListener){
		/*
		 * Implemented by - Paul Robinson
