 ...
 * {@link TMXLayerLowMemorySpriteBatch} since its pretty similar stuff.
 * This process a given object group, which the user believes are tiles, into a
 * {@link TMXLayerLowMemorySpriteBatch}. Be warned when operating on these
 * layers, always check for null values first.
 * 
 * @author Paul Robinson
 * 
 */
public class TMXLayerObjectTilesLowMemorySpriteBatch extends TMXLayerLowMemorySpriteBatch {
	 ...
	 */
	public TMXLayerObjectTilesLowMemorySpriteBatch(TMXTiledMap pTMXTiledMap, Attributes pAttributes,
